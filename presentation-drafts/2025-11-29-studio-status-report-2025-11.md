...
![Mermaid diagram of the kintespace.com pipeline](../presentation/image/day-path-2025-11-29-17-10-47.png)
...
![Obsidian Graph View of month 11](../presentation/image/day-path-2025-11-29-17-12-07.png)
...
- the [[Jupyter|Jupyter Notebooks]] 📓📓📓 will serve as a ‘work diary’ for the Publications Data
...
- both the live site and [[eleventy]] depend on static <acronym title="JavaScript Object Notation">JSON</acronym> generated by the `DataAccess` logic (currently in a test harness) on top of the [[SQLite]] database of the [[Songhay Publications Data|Publications Data]] schema 🗃
...
## [[Songhay Publications Internet Products|Studio Internet Products]]: yes, [[Bulma]] handles text alignment
...
![Bulma alignment helpers](../presentation/image/day-path-2025-11-29-17-19-47.png)
...
![StackOverflow answer](../presentation/image/day-path-2025-11-29-17-22-53.png)
...
![Clonezilla in expert mode](../presentation/image/day-path-2025-11-29-17-29-22.png)
...
![Clonezilla in expert mode skipping bad sectors](../presentation/image/day-path-2025-11-29-17-30-13.png)

## Internet Products: added _conventional_ [[eleventy]] `index.html` 😐

![VScode explorer view](../presentation/image/day-path-2025-11-29-17-33-24.png)
...
Almost every static <acronym title="HyperText Markup Language">HTML</acronym> publication in this Studio will have an Index file arrangement like the above (with `{{ content }}` and the ‘default’ snippets to `{% render …%}`).
...
This news means [[2025-11-16#Songhay Publications Internet Products Internet Products `src/scss/_bulma-colors.scss` needs to be swept 😐🧹|my plan]] to update `src/scss/_bulma-colors.scss` with latest [[Bulma]] docs has to be revisited.

## Internet Products:  `MarkdownEntryTests.ShouldAddTagsToPoetryFiles` was tested on one file 😐🎊

There are some concerns here:

![VSCode diff view](../presentation/image/day-path-2025-11-29-17-39-21.png)
...
## [[Songhay Publications Internet Products|Internet Products]]: what [[eleventy]] collections mean to this Studio 😐

In terms of [[Songhay Publications Data|Publications Data]], the Document \[🔗 [GitHub](https://github.com/BryanWilhite/Songhay.Publications/blob/main/Songhay.Publications/Models/Document.cs) \] does not refer to another Document. The Document depends on the Segment (and, perhaps, the `IndexKeyword`) to indirectly refer to other documents.
