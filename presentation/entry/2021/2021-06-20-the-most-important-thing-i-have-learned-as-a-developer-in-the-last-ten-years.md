...
- suggesting that we are in a state of emergency and we should be _doing_ instead of _writing_ which is a luxury for those not about to go out of business (apparently, for the last 10 years)
...
- when a bug breaks out related to my work, _not_ going back to read my card plan to see that my plan steps were _not_ related to the bug which implies the story needed to be rewritten and the Product Owner(s) are in error
